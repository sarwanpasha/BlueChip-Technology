<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Lattest.aspx.cs" Inherits="Lattest" Theme="ThemeForLattestPage" StyleSheetTheme="ThemeForLattestPage" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
            <title>Lattest News</title>
</asp:Content>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="homestream latest" id="latest">
				<h2 class="sectiontitle">Lattest</h2>
				<div class="list">
                    <!------------- Section1 Starts     --------->
