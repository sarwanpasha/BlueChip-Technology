<%@ Page Language="C#" AutoEventWireup="true" CodeFile="article10.aspx.cs" Inherits="article10" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>article10</title>
   <style>
* {
 margin: 0px;
 padding: 0px;
		...
		<div class="col-md-12">
			<div class="homestream latest" id="latest">
             ...
             <div class="pl pl-floathero">
                 ...
                 <br />
							<div class="block">
		<a href="/topic/sleep" class="kicker">gtrgtr</a>		
                                <h3><a href="/article/247728">bgfbtr</a></h3>

									<div class="deck">gtrgtrgtr</div>
					
									
				<div class="byline"><a href="/author/david-robson">gtrgtr</a></div>
							
														<time class="readtime"><i>7/23/2015 12:53:56 AM</i> </time>
										</div>
</div>
                                        <!------------- Section1 Ends     --------->
