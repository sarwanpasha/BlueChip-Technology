<%@ Page Language="C#" AutoEventWireup="true" CodeFile="article16.aspx.cs" Inherits="article16" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>article16</title>
   <style>
* {
 margin: 0px;
 padding: 0px;
		...
		<div class="col-md-12">
			<div class="homestream latest" id="latest">
             ...
             <div class="pl pl-floathero">
                 ...
                 <br />
							<div class="block">
		<a href="/topic/sleep" class="kicker">hythyt</a>
        <asp:Image id="authorImage" runat="server" src="images/8.jpg" data-original=" alt=" style="width: 47px; height: 27px" />
        <a href="/topic/sleep" class="kicker" style="position: absolute; left: 5.4em; top: 31.4em; width: 9.8em; height: 1.8em;">Authore Name</a>
                                 
                                <h3><a href="/article/247728">yhyth</a></h3>

									<div class="deck">hythyt</div>							
			<time class="readtime" style="position: absolute; left: 39.6em; top: 28.4em; width: 12em; height: 1.8em;"><i>8/12/2015 12:16:14 AM</i> </time>
										</div>
</div>
                                        <!------------- Section1 Ends     --------->
