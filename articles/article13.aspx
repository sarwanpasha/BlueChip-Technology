<%@ Page Language="C#" AutoEventWireup="true" CodeFile="article13.aspx.cs" Inherits="article13" %>
		...
		<div class="col-md-12">
			<div class="homestream latest" id="latest">
             ...
             <div class="pl pl-floathero">
				         <asp:Image  src="images/8.jpg" runat="server" alt="class-header-device"  class="lazy" /> 
                 <br />
							<div class="block">
		<a href="/topic/sleep" class="kicker">Organization</a>		
                                <h3><a href="/article/247728">Heading</a></h3>

									<div class="deck">jninoijo</div>
					
									
				<div class="byline"><a href="/author/david-robson">Author</a></div>
							
														<time class="readtime"><i>8/11/2015 11:46:26 PM</i> </time>
										</div>
</div>
                                        <!------------- Section1 Ends     --------->
