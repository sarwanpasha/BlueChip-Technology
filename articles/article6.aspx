<%@ Page Language="C#" AutoEventWireup="true" CodeFile="article6.aspx.cs" Inherits="article6" %>
		...
		<div class="col-md-12">
			<div class="homestream latest" id="latest">
             ...
             <div class="pl pl-floathero">
                 ...
                 <br />
							<div class="block">
		<a href="/topic/sleep" class="kicker">aaaaaaaaa</a>		
                                <h3><a href="/article/247728">aaaaaaa</a></h3>

									<div class="deck">aaaaaaaaaaaa</div>
					
									
				<div class="byline"><a href="/author/david-robson">aaaaaaaaa</a></div>
							
														<time class="readtime"><i>7/13/2015 4:30:35 PM</i> </time>
										</div>
</div>
                                        <!------------- Section1 Ends     --------->
