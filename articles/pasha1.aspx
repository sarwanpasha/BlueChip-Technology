<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pasha1.aspx.cs" Inherits="pasha1" %>
		...
		<div class="col-md-12">
			<div class="homestream latest" id="latest">
             ...
             <div class="pl pl-floathero">
                 ...
                 <br />
							<div class="block">
		<a href="/topic/sleep" class="kicker">BluechipTechnology</a>		
                                <h3><a href="/article/247728">Pasha</a></h3>

									<div class="deck">ggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggg</div>
					
									
				<div class="byline"><a href="/author/david-robson">Sarwan</a></div>
							
														<time class="readtime"><i>7/12/2015 12:31:28 AM</i> 11 min read</time>
										</div>
</div>
                                        <!------------- Section1 Ends     --------->
