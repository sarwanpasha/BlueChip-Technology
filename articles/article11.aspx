<%@ Page Language="C#" AutoEventWireup="true" CodeFile="article11.aspx.cs" Inherits="article11" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>article11</title>
   <style>
* {
 margin: 0px;
 padding: 0px;
		...
		<div class="col-md-12">
			<div class="homestream latest" id="latest">
             ...
             <div class="pl pl-floathero">
                 ...
                 <br />
							<div class="block">
		<a href="/topic/sleep" class="kicker">hyhyt</a>		
                                <h3><a href="/article/247728">ertgrr</a></h3>

									<div class="deck">hyythyt</div>
					
									
				<div class="byline"><a href="/author/david-robson">hgtrhgrtt</a></div>
							
														<time class="readtime"><i>8/3/2015 4:57:17 PM</i> </time>
										</div>
</div>
                                        <!------------- Section1 Ends     --------->
