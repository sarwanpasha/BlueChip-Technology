<%@ Page Language="C#" AutoEventWireup="true" CodeFile="article8.aspx.cs" Inherits="article8" %>
		...
		<div class="col-md-12">
			<div class="homestream latest" id="latest">
             ...
             <div class="pl pl-floathero">
                 ...
                 <br />
							<div class="block">
		<a href="/topic/sleep" class="kicker">greg</a>		
                                <h3><a href="/article/247728">rfdgdr</a></h3>

									<div class="deck">rgegre</div>
					
									
				<div class="byline"><a href="/author/david-robson">grdegrde</a></div>
							
														<time class="readtime"><i>7/23/2015 12:41:26 AM</i> </time>
										</div>
</div>
                                        <!------------- Section1 Ends     --------->
