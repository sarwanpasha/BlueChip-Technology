<%@ Page Language="C#" AutoEventWireup="true" CodeFile="article5.aspx.cs" Inherits="article5" %>
		...
		<div class="col-md-12">
			<div class="homestream latest" id="latest">
             ...
             <div class="pl pl-floathero">
                 ...
                 <br />
							<div class="block">
		<a href="/topic/sleep" class="kicker">rrrrrrrr</a>		
                                <h3><a href="/article/247728">bfrrrrrrr</a></h3>

									<div class="deck">rrrrrrrrrrrr</div>
					
									
				<div class="byline"><a href="/author/david-robson">brrrrrrrrrr</a></div>
							
														<time class="readtime"><i>7/13/2015 4:29:08 PM</i> </time>
										</div>
</div>
                                        <!------------- Section1 Ends     --------->
