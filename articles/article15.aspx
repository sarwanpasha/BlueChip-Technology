<%@ Page Language="C#" AutoEventWireup="true" CodeFile="article15.aspx.cs" Inherits="article15" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>article15</title>
   <style>
* {
 margin: 0px;
 padding: 0px;
		...
		<div class="col-md-12">
			<div class="homestream latest" id="latest">
             ...
             <div class="pl pl-floathero">
 					<img class="lazy" src="images/10.jpg" data-original=" alt=" />
				 
                 <br />
							<div class="block">
		<a href="/topic/sleep" class="kicker">jyjuyjr</a>		
                                <h3><a href="/article/247728">thyt</a></h3>

									<div class="deck">ytjytrjry</div>
					
									
				<div class="byline"><a href="/author/david-robson">hytjhrt</a></div>
							
														<time class="readtime"><i>8/12/2015 12:14:40 AM</i> </time>
										</div>
</div>
                                        <!------------- Section1 Ends     --------->
