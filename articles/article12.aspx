<%@ Page Language="C#" AutoEventWireup="true" CodeFile="article12.aspx.cs" Inherits="article12" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>article12</title>
   <style>
* {
 margin: 0px;
 padding: 0px;
	...
	<div class="row">
		...
		<a href="/topic/sleep" class="kicker">Pasha</a>		
                                <h3><a href="/article/247728">Title</a></h3>
									...
									<div class="deck">gggggggggggg</div>
					
									
				<div class="byline"><a href="/author/david-robson">sarwan</a></div>
							
														<time class="readtime"><i>8/11/2015 11:28:21 PM</i> </time>
										</div>
</div>
                                        <!------------- Section1 Ends     --------->
