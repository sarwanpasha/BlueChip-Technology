<%@ Page Language="C#" AutoEventWireup="true" CodeFile="article14.aspx.cs" Inherits="article14" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>article14</title>
   <style>
* {
 margin: 0px;
 padding: 0px;
		...
		<div class="col-md-12">
			<div class="homestream latest" id="latest">
             ...
             <div class="pl pl-floathero">
                 ...
                 <br />
							<div class="block">
		<a href="/topic/sleep" class="kicker">PASHA</a>		
                                <h3><a href="/article/247728">PASHA</a></h3>

									<div class="deck">PASHA</div>
					
									
				<div class="byline"><a href="/author/david-robson">PASHA</a></div>
							
														<time class="readtime"><i>8/12/2015 12:10:24 AM</i> </time>
										</div>
</div>
                                        <!------------- Section1 Ends     --------->
